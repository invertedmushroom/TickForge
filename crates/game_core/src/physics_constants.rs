...
pub const KCC_OFFSET_RELATIVE: f32 = 0.02; // skin width relative to the character capsule height
pub const KCC_AUTOSTEP_MAX_HEIGHT_RELATIVE: f32 = 0.15;
pub const KCC_AUTOSTEP_MIN_WIDTH_RELATIVE: f32 = 0.2;
pub const KCC_AUTOSTEP_INCLUDE_DYNAMIC_BODIES: bool = false;
pub const KCC_SNAP_TO_GROUND_RELATIVE: f32 = 0.2;
pub const KCC_NORMAL_NUDGE_FACTOR: f32 = 1.0e-3;
pub const KCC_MAX_SLOPE_CLIMB_RADIANS: f32 = std::f32::consts::FRAC_PI_4;
pub const KCC_MOVE_SHAPE_DT_SECONDS: f32 = 0.0; // server controls vertical motion outside Rapier KCC
